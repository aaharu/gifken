...
var _gifken = require("./gifken");

var GifPresenter = (function () {
    function GifPresenter() {
        _classCallCheck(this, GifPresenter);
    }

    _createClass(GifPresenter, null, [{
        key: "writeToBlob",
         ...
         * @return {Blob} BLOB
         **/
        value: function writeToBlob(bytes) {
        ...
        key: "writeToDataUrl",
        value: function writeToDataUrl(bytes) {
            var str = "";
...
(window || self).gifken = {
    Gif: _gifken.Gif,
    GifFrame: _gifken.GifFrame,
    GifColor: _gifken.GifColor,
    GifParser: _gifken.GifParser,
    GifVersion: _gifken.GifVersion,
    GifPresenter: GifPresenter
};

},{"./gifken":2}],2:[function(require,module,exports){
/*!
 gifken v0.1.0
 Copyright (c) 2013-2015 aaharu
 This software is released under the MIT License.
...
var Gif = (function () {
    ...
    function Gif(skipDefault) {
        ...
        this.globalColorTable = GifColor.createColorTable([new GifColor(0, 0, 0), new GifColor(255, 255, 255)]);
    }
    ...
    _createClass(Gif, [{
        ...
        key: "writeToArrayBuffer",
        value: function writeToArrayBuffer() {
        ...
        key: "split",
        value: function split(overwrite) {
            var _this = this;
        ...
        key: "playback",
        value: function playback(overwrite) {
            var _this2 = this;
            ...
            if (overwrite) {
                this.frames.forEach(function (frame, index) {
                    if (index !== 0 && frame.transparentFlag) {
                        ...
                        if (_this2.frames[index - 1].pixelData === undefined) {
                            _this2.frames[index - 1].decompress();
                        }
                        var edited = false;
                        for (var i = 0, l = frame.pixelData.length; i < l; ++i) {
                            if (frame.pixelData[i] === frame.transparentColorIndex) {
                                frame.pixelData[i] = _this2.frames[index - 1].pixelData[i];
                                edited = true;
                            }
                        }
                        if (edited) {
        ...
        key: "writeToArrayBuffer",
        value: function writeToArrayBuffer(gif) {
            var output = [];
            // write header
...
var GifFrame = (function () {
    ...
    function GifFrame() {
        _classCallCheck(this, GifFrame);
    }

    _createClass(GifFrame, [{
        key: "decompress",
...
var GifColor = (function () {
    ...
    function GifColor(r, g, b) {
        _classCallCheck(this, GifColor);
    ...
    _createClass(GifColor, null, [{
        key: "valueOf",
        value: function valueOf(color) {
            // TODO
        }
    }, {
        key: "createColorTable",
        value: function createColorTable(colors) {
            var numbers = [];
            for (var i = 1; i <= 8; ++i) {
...
var GifVersion;
exports.GifVersion = GifVersion;
(function (GifVersion) {
    GifVersion[GifVersion["GIF89a"] = 0] = "GIF89a";
    GifVersion[GifVersion["GIF87a"] = 1] = "GIF87a";
})(GifVersion || (exports.GifVersion = GifVersion = {}));
...
var GifParser = (function () {
    ...
    _createClass(GifParser, null, [{
        key: "readHeader",
        value: function readHeader(gif, data) {
        ...
        key: "readBlock",
        value: function readBlock(gif, data, offset) {
        ...
        key: "readImageBlock",
        value: function readImageBlock(frame, data, offset) {
        ...
        key: "readApplicationExtensionBlock",
        value: function readApplicationExtensionBlock(gif, data, offset) {
            offset += 2;
        ...
        key: "readCommentExtensionBlock",
        value: function readCommentExtensionBlock(gif, data, offset) {
            // skip
            offset += 2;
            while (true) {
                var blockSize = data.getUint8(offset++);
        ...
        key: "readGraphicControlExtensionBlock",
        value: function readGraphicControlExtensionBlock(frame, data, offset) {
        ...
        key: "readPlainTextExtensionBlock",
        value: function readPlainTextExtensionBlock(gif, data, offset) {
            // skip
            offset += 2;
            while (true) {
                var blockSize = data.getUint8(offset++);
...
var lzwDecode = function lzwDecode(minCodeSize, data, len) {
...
var GifCompressedCodesToByteArrayConverter = (function () {
    function GifCompressedCodesToByteArrayConverter() {
        _classCallCheck(this, GifCompressedCodesToByteArrayConverter);
    ...
    _createClass(GifCompressedCodesToByteArrayConverter, [{
        key: "push",
        value: function push(code, numBits) {
            while (numBits > 0) {
