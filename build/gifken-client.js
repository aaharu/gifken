...
var GifColor_1 = require("./GifColor");
var GifParser_1 = require("./GifParser");
var GifVersion_1 = require("./GifVersion");
var Gif = /** @class */ (function () {
    ...
    function Gif(skipDefault) {
        ...
        // default values
        this._version = GifVersion_1.GifVersion.GIF89a;
        this._width = 1;
        this._height = 1;
    ...
    Gif.parse = function (buffer) {
        ...
        var offset = GifParser_1.GifParser.readHeader(gif, data);
        while (true) {
            offset = GifParser_1.GifParser.readBlock(gif, data, offset);
            if (offset === -1) {
                break;
            }
        }
    ...
    Gif.prototype.versionName = function () {
        return GifVersion_1.GifVersion[this._version];
    };
    ...
    Gif.writeToArrayBuffer = function (gif) {
        ...
        if (gif.version === GifVersion_1.GifVersion.GIF89a) {
...
/*
 ===begin GifWriter.js===
 */
var GifCompressedCodesToByteArrayConverter = /** @class */ (function () {
...
var GifFrame = /** @class */ (function () {
    ...
    GifFrame.init = function (width, height) {
    ...
    GifFrame.prototype.decompress = function () {
 ...
 */
Object.defineProperty(exports, "__esModule", { value: true });
var GifFrame_1 = require("./GifFrame");
var GifVersion_1 = require("./GifVersion");
var GifParser = /** @class */ (function () {
    function GifParser() {
    }
    GifParser.readHeader = function (gif, data) {
        ...
        if (version == GifVersion_1.GifVersion.GIF87a) {
            gif.version = GifVersion_1.GifVersion.GIF87a;
        }
        else {
            gif.version = GifVersion_1.GifVersion.GIF89a;
        }
    ...
    GifParser.readCommentExtensionBlock = function (data, offset) {
        // skip
        offset += 2;
        while (true) {
            var blockSize = data.getUint8(offset++);
    ...
    GifParser.readPlainTextExtensionBlock = function (data, offset) {
        // skip
        offset += 2;
        while (true) {
            var blockSize = data.getUint8(offset++);
 ...
 */
Object.defineProperty(exports, "__esModule", { value: true });
var GifPresenter = /** @class */ (function () {
...
})(GifVersion = exports.GifVersion || (exports.GifVersion = {}));
...
var GifPresenter_1 = require("./GifPresenter");
(window || self).gifken = {
    Gif: Gif_1.Gif,
    GifFrame: GifFrame_1.GifFrame,
    GifColor: GifColor_1.GifColor,
    GifParser: GifParser_1.GifParser,
    GifVersion: GifVersion_1.GifVersion,
    GifPresenter: GifPresenter_1.GifPresenter
};
