...
export class GifParser {
    ...
    static readImageBlock(frame:GifFrame, data:DataView, offset:number):number {
    ...
    static readApplicationExtensionBlock(gif:GifImage, data:DataView, offset:number):number {
        offset += 2;
    ...
    static readGraphicControlExtensionBlock(frame:GifFrame, data:DataView, offset:number):number {
